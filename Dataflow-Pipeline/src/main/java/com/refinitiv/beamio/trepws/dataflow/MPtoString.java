...
public class MPtoString extends DoFn<MarketPriceMessage,String> {

	private static final long serialVersionUID = -4854710948118672811L;

	@ProcessElement
	public void processElement(ProcessContext context) {
		MarketPriceMessage mp = context.element();
		Instant timestamp = mp.getTimestamp();
		context.outputWithTimestamp(mp.getJsonString(), timestamp);	
	}
}
